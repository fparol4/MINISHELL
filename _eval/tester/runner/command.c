...
describe(rn_execute_cmd)
{
	...
	{
		char		path[] = "tester/_tmp/minishell_exec_dir_XXXXXX";
		char		*raw[] = {path, NULL};
		t_env		*env = NULL;
		t_command	node;
		char		*err;
	...
	{
		char		path[] = "tester/_tmp/minishell_exec_noexec_XXXXXX";
		char		*raw[] = {path, NULL};
		t_env		*env = NULL;
		t_command	node;
		char		*err;
	...
	{
		char		path[] = "tester/_tmp/minishell_exec_format_XXXXXX";
		char		*raw[] = {path, NULL};
		t_env		*env = NULL;
		t_command	node;
		char		*err;
	...
	{
		char	dir[] = "tester/_tmp/minishell_path_dir_XXXXXX";
