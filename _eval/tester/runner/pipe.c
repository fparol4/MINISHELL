...
describe(rn_pipe)
{
	...
	{
		char			path[] = "tester/_tmp/minishell_pipe_in_XXXXXX";
		char			*envp[] = {"PATH=/usr/bin:/bin", NULL};
	...
	{
		char			path[] = "tester/_tmp/minishell_pipe_out_XXXXXX";
		char			*envp[] = {"PATH=/usr/bin:/bin", NULL};
	...
	{
		char			path[] = "tester/_tmp/minishell_pipe_left_out_XXXXXX";
		char			*envp[] = {"PATH=/usr/bin:/bin", NULL};
		char			*left_args[] = {"echo", "hi", NULL};
		char			*right_args[] = {"wc", "-c", NULL};
		t_env			*env = env_init(envp);
	...
	{
		char			path[] = "tester/_tmp/minishell_pipe_right_in_XXXXXX";
		char			*envp[] = {"PATH=/usr/bin:/bin", NULL};
	...
	{
		char			path_a[] = "tester/_tmp/minishell_pipe_in_a_XXXXXX";
		char			path_b[] = "tester/_tmp/minishell_pipe_in_b_XXXXXX";
		char			*envp[] = {"PATH=/usr/bin:/bin", NULL};
		char			*left_args[] = {"cat", NULL};
		char			*right_args[] = {"cat", NULL};
		t_env			*env = env_init(envp);
	...
	{
		char			path_a[] = "tester/_tmp/minishell_pipe_out_a_XXXXXX";
		char			path_b[] = "tester/_tmp/minishell_pipe_out_b_XXXXXX";
		char			*envp[] = {"PATH=/usr/bin:/bin", NULL};
		char			*left_args[] = {"echo", "pipe", NULL};
		char			*right_args[] = {"cat", NULL};
		t_env			*env = env_init(envp);
	...
	{
		char			path[] = "tester/_tmp/minishell_pipe_hd_override_XXXXXX";
		char			*envp[] = {"PATH=/usr/bin:/bin", NULL};
		char			*left_args[] = {"cat", NULL};
		char			*right_args[] = {"cat", NULL};
		t_env			*env = env_init(envp);
	...
	{
		char			path[] = "tester/_tmp/minishell_pipe_missing_input_XXXXXX";
		char			*envp[] = {"PATH=/usr/bin:/bin", NULL};
		char			*left_args[] = {"echo", "hi", NULL};
		char			*right_args[] = {"cat", NULL};
		t_env			*env = env_init(envp);
